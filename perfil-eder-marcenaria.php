							...
							<div class="song-details-box">
								...
								<div class="artist-details">
									<div class="foto-perfil text-center">
										<img src="img/foto-perfil/eder-marcenaria.png" alt="foto-perfil">
									</div>
									<!--
									<div class="rating">
									...
									<div class="">
										<div class="row mt-5">
											<div class="info">
												<div class="empresa">
													<div class="mb-5">
														<img src="img/logomarca/eder-marceneiro.png" width="250px" alt="logo-empresa">
													</div>
													<hr>
												</div>
												<div class="address">
												...
												<div class="phone">
													<h4>Telefone:</h4>
													<p>(92) 99193-3007 /(92) 99182-9111</p>
												</div>
												<hr>
	...
	<section class="songs-details-section" style="padding-top: 10px !important;">
		...
		<div class="container">
			...
			<div class="mySlides">
				...
				<img src="img/carousel/eder/balcao-cozinha-720x480.png" style="width:100%">
			</div>
